...
function wpcf7_acceptance_mail_tag( $replaced, $submitted, $html, $mail_tag ) {
	...
	if ( ! empty( $submitted ) ) {
		$replaced = __( 'Consented', 'lc_studio_contact_form' );
	} else {
		$replaced = __( 'Not consented', 'lc_studio_contact_form' );
	}
...
function wpcf7_add_tag_generator_acceptance() {
	...
	$tag_generator->add( 'acceptance', __( 'acceptance', 'lc_studio_contact_form' ),
...
function wpcf7_tag_generator_acceptance( $contact_form, $args = '' ) {
	...
	$description = __( "Generate a form-tag for an acceptance checkbox. For more details, see %s.", 'lc_studio_contact_form' );

	$desc_link = wpcf7_link( __( 'https://contactform7.com/acceptance-checkbox/', 'lc_studio_contact_form' ), __( 'Acceptance checkbox', 'lc_studio_contact_form' ) );
...
<tbody>
	...
	<tr>
	<th scope="row"><label for="<?php echo esc_attr( $args['content'] . '-content' ); ?>"><?php echo esc_html( __( 'Condition', 'lc_studio_contact_form' ) ); ?></label></th>
	...
	<td>
		...
		<label><input type="checkbox" name="optional" class="option" checked="checked" /> <?php echo esc_html( __( 'Make this checkbox optional', 'lc_studio_contact_form' ) ); ?></label>
		</fieldset>
	</td>
	</tr>
