...
function wpcf7_add_tag_generator_menu() {
	...
	$tag_generator->add( 'menu', __( 'drop-down menu', 'lc_studio_contact_form' ),
...
function wpcf7_tag_generator_menu( $contact_form, $args = '' ) {
	...
	$description = __( "Generate a form-tag for a drop-down menu. For more details, see %s.", 'lc_studio_contact_form' );
...
<tbody>
	...
	<td>
		...
		<label><input type="checkbox" name="multiple" class="option" /> <?php echo esc_html( __( 'Allow multiple selections', 'lc_studio_contact_form' ) ); ?></label><br />
		<label><input type="checkbox" name="include_blank" class="option" /> <?php echo esc_html( __( 'Insert a blank item as the first option', 'lc_studio_contact_form' ) ); ?></label>
		</fieldset>
	</td>
	</tr>
