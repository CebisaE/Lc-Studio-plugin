...
function wpcf7_constant_contact_editor_panels( $panels ) {
	...
	$editor_panel = function () use ( $prop, $service ) {
		...
		$description = sprintf(
			esc_html(
				__( "You can set up the Constant Contact integration here. For details, see %s.", 'lc_studio_contact_form' )
			),
			wpcf7_link(
...
?>
<h2><?php echo esc_html( __( 'Constant Contact', 'lc_studio_contact_form' ) ); ?></h2>
...
<?php
	...
	$panels += array(
		'ctct-panel' => array(
			'title' => __( 'Constant Contact', 'lc_studio_contact_form' ),
