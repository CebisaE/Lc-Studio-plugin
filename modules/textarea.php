...
function wpcf7_add_tag_generator_textarea() {
	...
	$tag_generator->add( 'textarea', __( 'text area', 'lc_studio_contact_form' ),
...
function wpcf7_tag_generator_textarea( $contact_form, $args = '' ) {
	...
	$description = __( "Generate a form-tag for a multi-line text input field. For more details, see %s.", 'lc_studio_contact_form' );
