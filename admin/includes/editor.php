...
function wpcf7_editor_panel_form( $post ) {
	$desc_link = wpcf7_link(
		__( '', 'lc_studio_contact_form' ),
		__( 'Editing form template', 'lc_studio_contact_form' ) );
	$description = __( "You can edit the form template here. For details, see %s.", 'lc_studio_contact_form' );
	$description = sprintf( esc_html( $description ), $desc_link );
?>

<h2><?php echo esc_html( __( 'Form', 'lc_studio_contact_form' ) ); ?></h2>
...
function wpcf7_editor_panel_mail( $post ) {
	...
	wpcf7_editor_box_mail( $post, array(
		'id' => 'wpcf7-mail-2',
		'name' => 'mail_2',
		'title' => __( 'Mail (2)', 'lc_studio_contact_form' ),
		'use' => __( 'Use Mail (2)', 'lc_studio_contact_form' ),
	) );
}
...
<p class="description"><?php echo esc_html( __( "Mail (2) is an additional mail template often used as an autoresponder.", 'lc_studio_contact_form' ) ); ?></p>
<?php
	endif;
?>
...
<?php
	$desc_link = wpcf7_link(
		__( '', 'lc_studio_contact_form' ),
		__( 'Setting up mail', 'lc_studio_contact_form' ) );
	$description = __( "You can edit the mail template here. For details, see %s.", 'lc_studio_contact_form' );
	$description = sprintf( esc_html( $description ), $desc_link );
	echo $description;
	echo '<br />';
...
<tbody>
	<tr>
	<th scope="row">
		<label for="<?php echo $id; ?>-recipient"><?php echo esc_html( __( 'To', 'lc_studio_contact_form' ) ); ?></label>
	</th>
	<td>
	...
	<tr>
	<th scope="row">
		<label for="<?php echo $id; ?>-sender"><?php echo esc_html( __( 'From', 'lc_studio_contact_form' ) ); ?></label>
	</th>
	<td>
	...
	<tr>
	<th scope="row">
		<label for="<?php echo $id; ?>-subject"><?php echo esc_html( __( 'Subject', 'lc_studio_contact_form' ) ); ?></label>
	</th>
	<td>
	...
	<tr>
	<th scope="row">
		<label for="<?php echo $id; ?>-additional-headers"><?php echo esc_html( __( 'Additional headers', 'lc_studio_contact_form' ) ); ?></label>
	</th>
	<td>
	...
	<tr>
	<th scope="row">
		<label for="<?php echo $id; ?>-body"><?php echo esc_html( __( 'Message body', 'lc_studio_contact_form' ) ); ?></label>
	</th>
	<td>
		...
		<p><label for="<?php echo $id; ?>-exclude-blank"><input type="checkbox" id="<?php echo $id; ?>-exclude-blank" name="<?php echo $id; ?>[exclude_blank]" value="1"<?php echo ( ! empty( $mail['exclude_blank'] ) ) ? ' checked="checked"' : ''; ?> /> <?php echo esc_html( __( 'Exclude lines with blank mail-tags from output', 'lc_studio_contact_form' ) ); ?></label></p>

		<p><label for="<?php echo $id; ?>-use-html"><input type="checkbox" id="<?php echo $id; ?>-use-html" name="<?php echo $id; ?>[use_html]" value="1"<?php echo ( $mail['use_html'] ) ? ' checked="checked"' : ''; ?> /> <?php echo esc_html( __( 'Use HTML content type', 'lc_studio_contact_form' ) ); ?></label></p>
	</td>
	</tr>

	<tr>
	<th scope="row">
		<label for="<?php echo $id; ?>-attachments"><?php echo esc_html( __( 'File attachments', 'lc_studio_contact_form' ) ); ?></label>
	</th>
	<td>
...
function wpcf7_editor_panel_messages( $post ) {
	$desc_link = wpcf7_link(
		__( '', 'lc_studio_contact_form' ),
		__( 'Editing messages', 'lc_studio_contact_form' ) );
	$description = __( "You can edit messages used in various situations here. For details, see %s.", 'lc_studio_contact_form' );
	$description = sprintf( esc_html( $description ), $desc_link );
...
?>
<h2><?php echo esc_html( __( 'Messages', 'lc_studio_contact_form' ) ); ?></h2>
<fieldset>
<legend><?php echo $description; ?></legend>
<?php
...
function wpcf7_editor_panel_additional_settings( $post ) {
	...
	$description = __( "You can add customization code snippets here. For details, see %s.", 'lc_studio_contact_form' );
	$description = sprintf( esc_html( $description ), $desc_link );

?>
<h2><?php echo esc_html( __( 'Additional Settings', 'lc_studio_contact_form' ) ); ?></h2>
<fieldset>
<legend><?php echo $description; ?></legend>
