...
class WPCF7_Integration {
	...
	public static function get_builtin_categories() {
		return array(
			'spam_protection' => __( 'Spam protection', 'lc_studio_contact_form' ),
			'email_marketing' => __( 'Email marketing', 'lc_studio_contact_form' ),
			'payments' => __( 'Payments', 'lc_studio_contact_form' ),
		);
	}
