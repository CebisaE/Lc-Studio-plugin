...
add_action(
	...
	function () {
		...
		wp_register_script(
			'lc_studio_contact_form-html5-fallback',
...
function wpcf7_enqueue_scripts() {
	wp_enqueue_script( 'lc_studio_contact_form' );
	...
	wp_localize_script( 'lc_studio_contact_form', 'wpcf7', $wpcf7 );
...
function wpcf7_script_is() {
	return wp_script_is( 'lc_studio_contact_form' );
}
...
function wpcf7_enqueue_styles() {
	wp_enqueue_style( 'lc_studio_contact_form' );

	if ( wpcf7_is_rtl() ) {
		wp_enqueue_style( 'lc_studio_contact_form-rtl' );
	}
...
function wpcf7_style_is() {
	return wp_style_is( 'lc_studio_contact_form' );
}
...
function wpcf7_html5_fallback() {
	...
	if ( wpcf7_script_is() ) {
		wp_enqueue_script( 'lc_studio_contact_form-html5-fallback' );
	}
