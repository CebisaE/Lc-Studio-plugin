...
class WPCF7_ContactForm {
	...
	public static function register_post_type() {
		register_post_type( self::post_type, array(
			'labels' => array(
				'name' => __( 'Contact Forms', 'lc_studio_contact_form' ),
				'singular_name' => __( 'Contact Form', 'lc_studio_contact_form' ),
			),
			'rewrite' => false,
			'query_var' => false,
			'public' => false,
	...
	public static function get_template( $args = '' ) {
		$args = wp_parse_args( $args, array(
			'locale' => '',
			'title' => __( 'Untitled', 'lc_studio_contact_form' ),
		) );
	...
	public function __get( $name ) {
		$message = __( '<code>%1$s</code> property of a <code>WPCF7_ContactForm</code> object is <strong>no longer accessible</strong>. Use <code>%2$s</code> method instead.', 'lc_studio_contact_form' );
	...
	public function shortcode( $args = '' ) {
		...
		if ( $args['use_old_format'] ) {
			...
			$shortcode = sprintf(
				'[lc_studio_contact_form id="%1$d" title="%2$s"]',
				$this->id,
				$title
			);
		}
